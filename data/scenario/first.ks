...
[link storage = "ギャラリー.ks" target = "*CG_gallery"]CG mode[endlink]｜[link storage = "ギャラリー.ks" target = "*RP_gallery"]Reminiscence mode[endlink][r]
[link target="*全回想フラグオン"]All flashback flag on[endlink]｜[link target="*全回想フラグオフ"]All flashback flag off[endlink][r][pcm]

[link storage="01_オープニング.ks"]01_Opening[endlink]｜[link storage="インターミッション01.ks"]Intermission 01[endlink][r]
[link storage="インターミッション02.ks"]Intermission 02[endlink]｜[link storage="インターミッション03.ks"]Intermission 03[endlink][r]
[link storage="地下1.ks"]underground 1[endlink]｜[link storage="地下2.ks"]underground 2[endlink][r]
[link storage="地下3.ks"]underground 3[endlink]｜[link storage="地下4.ks"]underground 4[endlink][pcm]
[link storage="地下4BEルート.ks"]Underground 4BE√[endlink]｜[link storage="地下4GEルート.ks"]Underground 4GE√[endlink][r]
[link storage="地下4エロシーン.ks"]Underground 4 erotic scene[endlink]｜[link storage="地下5.ks"]underground 5[endlink][r]
[link storage="地下5エロシーン.ks"]Underground 5 erotic scene[endlink]｜[link storage="地下6_BE.ks"]Underground 6_BE[endlink][r]
[link storage="地下6_GE.ks"]Underground 6_GE[endlink]｜[link storage="地上1.ks"]above ground 1[endlink][pcm]
[link storage="地上2.ks"]above ground 2[endlink]｜[link storage="地上3.ks"]above ground 3[endlink][r]
[link storage="地上4.ks"]above ground 4[endlink]｜[link storage="地上4BEルート.ks"]Ground 4BE√[endlink][r]
[link storage="地上4GEルート.ks"]Ground 4GE√[endlink]｜[link storage="地上4エロシーン.ks"]4 erotic scenes on the ground[endlink][r]
[link storage="地上5.ks"]above ground 5[endlink]｜[link storage="地上5エロシーン.ks"]5 erotic scenes on the ground[endlink][pcm]
[link storage="地上6_BE.ks"]Above ground 6_BE[endlink]｜[link storage="地上6_GE.ks"]Above ground 6_GE[endlink][r]
[link storage="地上地下共通エンディング.ks"]Above ground and underground common ED[endlink]｜[pcm]
[endnowait]
[s]
